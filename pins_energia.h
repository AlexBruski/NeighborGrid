...
static const uint8_t P2_3 = 18;
static const uint8_t P2_4 = 19;
...
static const uint8_t P3_5 = 23;
static const uint8_t P3_4 = 24;
static const uint8_t P3_3 = 25;
static const uint8_t P3_2 = 26;
static const uint8_t P3_1 = 27;
...
const uint8_t digital_pin_to_timer[] = {
   ...
   T0A1,         /* 19 - XIN - P2.6: */
   NOT_ON_TIMER, /* 20 - GND */
   NOT_ON_TIMER, /* 21 - port3.7 */
   NOT_ON_TIMER, /* 22 - port3.6 */
   NOT_ON_TIMER, /* 23 - port3.5 */
   NOT_ON_TIMER, /* 24 - port3.4 */
   NOT_ON_TIMER, /* 25 - port3.3 */
   NOT_ON_TIMER, /* 26 - port3.2 */
   NOT_ON_TIMER, /* 27 - port3.1 */
   NOT_ON_TIMER, /* 28 - port3.0 */
};
